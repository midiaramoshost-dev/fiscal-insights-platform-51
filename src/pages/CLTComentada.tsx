  ...
  },
  {
    ...
    artigos: [
      ...
      },
      {
        ...
        textoLegal: "Salvo nos casos de revezamento semanal ou quinzenal, o trabalho noturno terá remuneração superior a do diurno e, para esse efeito, sua remuneração terá um acréscimo de 20% (vinte por cento), pelo menos, sobre a hora diurna. § 1º A hora do trabalho noturno será computada como de 52 minutos e 30 segundos. § 2º Considera-se noturno, para os efeitos deste artigo, o trabalho executado entre as 22 horas de um dia e as 5 horas do dia seguinte.",
        comentario: "O trabalho noturno urbano (22h às 5h) tem adicional mínimo de 20% e hora reduzida (52min30s). Para o trabalhador rural, a hora noturna é integral e o adicional é de 25% (Lei 5.889/73).",
        analise: "O adicional noturno integra o salário para todos os efeitos (13º, férias, FGTS, aviso prévio). A jornada noturna prorrogada após as 5h também recebe o adicional (Súmula 60, II, TST).",
        interpretacao: "A Súmula 265 do TST determina que a transferência do empregado do horário noturno para o diurno implica a perda do adicional noturno (não há direito adquirido).",
        orientacao: "Calcule corretamente a hora reduzida. Em caso de prorrogação após 5h, mantenha o adicional. Convenções coletivas frequentemente estabelecem percentuais superiores a 20%.",
        palavrasChave: ["trabalho noturno", "adicional noturno", "hora reduzida", "jornada"],
      },
      {
        numero: "Art. 129",
        titulo: "Direito a Férias Anuais",
        textoLegal: "Todo empregado terá direito anualmente ao gozo de um período de férias, sem prejuízo da remuneração.",
        comentario: "As férias são direito constitucional (art. 7º, XVII, CF/88) e devem ser concedidas em até 12 meses após a aquisição (período concessivo).",
        analise: "Período aquisitivo: 12 meses de trabalho. Período concessivo: 12 meses seguintes. Após esse prazo, as férias são pagas em dobro (art. 137).",
        interpretacao: "A remuneração das férias deve ser acrescida do terço constitucional (1/3), conforme art. 7º, XVII da CF/88. O pagamento é até 2 dias antes do início do gozo (art. 145).",
        orientacao: "Programe as férias com antecedência mínima de 30 dias. Evite acúmulo de períodos vencidos. Pague o terço constitucional e antecipe o pagamento conforme exigido.",
        palavrasChave: ["férias", "período aquisitivo", "período concessivo", "terço constitucional"],
      },
      {
        numero: "Art. 130",
        titulo: "Duração das Férias e Faltas",
        textoLegal: "Após cada período de doze meses de vigência do contrato de trabalho, o empregado terá direito a férias na seguinte proporção: I - 30 dias corridos, quando não houver faltado ao serviço mais de 5 vezes; II - 24 dias corridos, quando houver tido de 6 a 14 faltas; III - 18 dias corridos, quando houver tido de 15 a 23 faltas; IV - 12 dias corridos, quando houver tido de 24 a 32 faltas.",
        comentario: "A duração das férias depende do número de faltas injustificadas no período aquisitivo. Faltas justificadas (atestados, casamento, falecimento etc.) não contam.",
        analise: "Acima de 32 faltas injustificadas, o empregado perde o direito às férias daquele período aquisitivo. As faltas legais (art. 473) não são consideradas para esta contagem.",
        interpretacao: "A jurisprudência considera que o desconto das férias por faltas só pode ocorrer se o empregador comprovar a injustificabilidade. O ônus da prova é do empregador.",
        orientacao: "Mantenha controle rigoroso de presença. Documente todas as ausências. Comunique ao empregado o impacto das faltas no direito às férias.",
        palavrasChave: ["férias proporcionais", "faltas", "duração", "período aquisitivo"],
      },
      {
        numero: "Art. 134",
        titulo: "Fracionamento das Férias",
        textoLegal: "As férias serão concedidas por ato do empregador, em um só período, nos 12 meses subsequentes à data em que o empregado tiver adquirido o direito. § 1º Desde que haja concordância do empregado, as férias poderão ser usufruídas em até três períodos, sendo que um deles não poderá ser inferior a quatorze dias corridos e os demais não poderão ser inferiores a cinco dias corridos, cada um. § 3º É vedado o início das férias no período de dois dias que antecede feriado ou dia de repouso semanal remunerado.",
        comentario: "A Reforma Trabalhista flexibilizou o fracionamento das férias, permitindo divisão em até 3 períodos (antes era apenas 2 e em casos excepcionais).",
        analise: "Regras: (1) um período mínimo de 14 dias; (2) os demais, no mínimo 5 dias cada; (3) concordância do empregado; (4) não pode iniciar nos 2 dias antes de feriado ou DSR.",
        interpretacao: "A vedação de início próximo a feriado/DSR (§ 3º) busca evitar que o trabalhador 'perca' parte das férias com dias que já seriam de descanso.",
        orientacao: "Negocie o fracionamento com o empregado, formalizando por escrito. Atenção ao cumprimento dos limites mínimos.",
        palavrasChave: ["fracionamento", "férias", "três períodos", "concordância"],
      },
      {
        numero: "Art. 143",
        titulo: "Abono Pecuniário (Venda de Férias)",
        textoLegal: "É facultado ao empregado converter 1/3 do período de férias a que tiver direito em abono pecuniário, no valor da remuneração que lhe seria devida nos dias correspondentes.",
        comentario: "O empregado pode 'vender' até 1/3 das suas férias ao empregador. Em férias de 30 dias, pode vender 10 dias e gozar 20.",
        analise: "O requerimento deve ser feito até 15 dias antes do término do período aquisitivo (§ 1º). O empregador é obrigado a pagar o abono se solicitado tempestivamente.",
        interpretacao: "O abono pecuniário tem natureza indenizatória, não integrando a base de cálculo do FGTS, INSS e IRRF (jurisprudência consolidada).",
        orientacao: "Comunique aos empregados sobre o direito de conversão. Respeite o prazo de solicitação. Não trate o abono como remuneração para evitar autuações.",
        palavrasChave: ["abono pecuniário", "venda de férias", "1/3", "indenização"],
      },
      {
        numero: "Art. 192",
        titulo: "Adicional de Insalubridade",
        textoLegal: "O exercício de trabalho em condições insalubres, acima dos limites de tolerância estabelecidos pelo Ministério do Trabalho, assegura a percepção de adicional respectivamente de 40%, 20% e 10% do salário-mínimo da região, segundo se classifiquem nos graus máximo, médio e mínimo.",
        comentario: "O adicional compensa a exposição a agentes nocivos à saúde (químicos, físicos, biológicos), conforme NR-15.",
        analise: "Súmula Vinculante 4 do STF: a base de cálculo é o salário mínimo até que sobrevenha lei ou negociação coletiva dispondo diferentemente.",
        interpretacao: "Não há acumulação de insalubridade e periculosidade (art. 193, § 2º) - o empregado deve optar pelo mais vantajoso. A caracterização exige perícia técnica.",
        orientacao: "Realize laudos técnicos periódicos (LTCAT). Forneça EPI eficaz (a entrega correta pode neutralizar a insalubridade - Súmula 80 TST).",
        palavrasChave: ["insalubridade", "adicional", "NR-15", "EPI"],
      },
      {
        numero: "Art. 193",
        titulo: "Adicional de Periculosidade",
        textoLegal: "São consideradas atividades perigosas aquelas que impliquem risco acentuado em virtude de exposição permanente a: I - inflamáveis, explosivos ou energia elétrica; II - roubos ou outras espécies de violência física nas atividades de segurança pessoal ou patrimonial. § 1º O trabalho em condições de periculosidade assegura ao empregado um adicional de 30% sobre o salário sem os acréscimos de gratificações, prêmios ou participações nos lucros. § 4º São também consideradas perigosas as atividades de trabalhador em motocicleta.",
        comentario: "Adicional fixo de 30% sobre o salário-base. Inclui inflamáveis, explosivos, eletricidade, segurança patrimonial e motociclistas (Lei 12.997/2014).",
        analise: "Diferente da insalubridade, a base de cálculo é o salário-base do empregado. A caracterização exige perícia (art. 195).",
        interpretacao: "O TST entende que mesmo a exposição intermitente pode gerar o direito ao adicional, desde que não seja eventual (Súmula 364).",
        orientacao: "Identifique todas as atividades perigosas. Realize laudo técnico. O adicional integra o salário para todos os efeitos legais.",
        palavrasChave: ["periculosidade", "adicional", "30%", "inflamáveis", "motociclista"],
      },
    ],
  },
  {
    titulo: "Título II-A – Proteção à Mulher e Maternidade (Arts. 372 a 401)",
    artigos: [
      {
        numero: "Art. 392",
        titulo: "Licença-Maternidade",
        textoLegal: "A empregada gestante tem direito à licença-maternidade de 120 (cento e vinte) dias, sem prejuízo do emprego e do salário. § 1º A empregada deve, mediante atestado médico, notificar o seu empregador da data do início do afastamento do emprego, que poderá ocorrer entre o 28º dia antes do parto e ocorrência deste. § 4º É garantido à empregada, durante a gravidez, sem prejuízo do salário e demais direitos: I - transferência de função, quando as condições de saúde o exigirem; II - dispensa do horário de trabalho pelo tempo necessário para a realização de, no mínimo, seis consultas médicas e demais exames complementares.",
        comentario: "Direito constitucional (art. 7º, XVIII, CF/88). 120 dias podendo ser estendido para 180 dias pelas empresas aderentes ao Programa Empresa Cidadã (Lei 11.770/2008).",
        analise: "A licença é custeada pela Previdência Social (salário-maternidade). O empregador adianta o valor e compensa nas contribuições previdenciárias devidas.",
        interpretacao: "A estabilidade da gestante (ADCT, art. 10, II, b) vai da confirmação da gravidez até 5 meses após o parto, mesmo em contratos por prazo determinado (Súmula 244 TST).",
        orientacao: "Adira ao Empresa Cidadã se possível. Garanta as dispensas para consultas. Evite qualquer ato que possa ser interpretado como discriminação.",
        palavrasChave: ["licença-maternidade", "gestante", "120 dias", "Empresa Cidadã", "estabilidade"],
      },
      {
        numero: "Art. 396",
        titulo: "Intervalo para Amamentação",
        textoLegal: "Para amamentar seu filho, inclusive se advindo de adoção, até que este complete 6 meses de idade, a mulher terá direito, durante a jornada de trabalho, a 2 (dois) descansos especiais de meia hora cada um. § 2º Os horários dos descansos previstos no caput deverão ser definidos em acordo individual entre a mulher e o empregador.",
        comentario: "Direito da empregada à pausa para amamentação até os 6 meses do bebê. A Reforma Trabalhista permitiu a definição dos horários por acordo individual.",
        analise: "O período pode ser estendido por prescrição médica. Os descansos não são descontados da jornada e devem ser remunerados normalmente.",
        interpretacao: "Em caso de impossibilidade de amamentação no local de trabalho, a empresa pode oferecer redução da jornada ou liberação antecipada.",
        orientacao: "Estruture local apropriado para amamentação ou ordenha (sala de apoio). Negocie horários com a empregada. Documente o acordo individual.",
        palavrasChave: ["amamentação", "intervalo", "6 meses", "lactante", "pausa"],
      },
      {
        numero: "Art. 461",
        titulo: "Equiparação Salarial",
        textoLegal: "Sendo idêntica a função, a todo trabalho de igual valor, prestado ao mesmo empregador, no mesmo estabelecimento empresarial, corresponderá igual salário, sem distinção de sexo, etnia, nacionalidade ou idade. § 1º Trabalho de igual valor, para os fins deste Capítulo, será o que for feito com igual produtividade e com a mesma perfeição técnica, entre pessoas cuja diferença de tempo de serviço para o mesmo empregador não seja superior a quatro anos e a diferença de tempo na função não seja superior a dois anos. § 6º No caso de comprovada discriminação por motivo de sexo ou etnia, o juízo determinará, além do pagamento das diferenças salariais devidas, multa, em favor do empregado discriminado, no valor de 50% do limite máximo dos benefícios do Regime Geral de Previdência Social.",
        comentario: "A Reforma Trabalhista alterou os requisitos: agora exige mesmo estabelecimento (não mais mesma localidade), e introduziu limites de 4 anos de empresa e 2 anos na função.",
        analise: "Requisitos cumulativos: (1) função idêntica; (2) mesmo empregador; (3) mesmo estabelecimento; (4) trabalho de igual valor; (5) diferença de tempo dentro dos limites; (6) inexistência de quadro de carreira homologado.",
        interpretacao: "A Lei 14.611/2023 (Igualdade Salarial) reforçou as regras, criando o Relatório de Transparência Salarial obrigatório para empresas com 100+ empregados, com penalidades severas.",
        orientacao: "Mantenha quadro de carreira atualizado. Documente critérios objetivos de promoção. Realize avaliação de desempenho documentada. Esteja atento à Lei de Igualdade Salarial.",
        palavrasChave: ["equiparação salarial", "isonomia", "igual função", "discriminação", "461"],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    artigos: [
      ...
      },
      {
        numero: "Art. 487",
        titulo: "Aviso Prévio",
        textoLegal: "Não havendo prazo estipulado, a parte que, sem justo motivo, quiser rescindir o contrato deverá avisar a outra da sua resolução com a antecedência mínima de: I - oito dias, se o pagamento for efetuado por semana ou tempo inferior; II - trinta dias aos que perceberem por quinzena ou mês, ou que tenham mais de 12 meses de serviço na empresa. § 1º A falta do aviso prévio por parte do empregador dá ao empregado o direito aos salários correspondentes ao prazo do aviso, garantida sempre a integração desse período no seu tempo de serviço.",
        comentario: "O aviso prévio é a comunicação prévia obrigatória da rescisão. Pode ser trabalhado ou indenizado. Aplica-se à rescisão sem justa causa por parte do empregador ou ao pedido de demissão.",
        analise: "A Lei 12.506/2011 estabeleceu o aviso prévio proporcional: 30 dias + 3 dias por ano completo trabalhado, até o limite de 90 dias. Esses dias adicionais aplicam-se apenas em favor do empregado.",
        interpretacao: "Súmula 276 TST: o pedido de demissão não pode ser objeto de renúncia pelo empregador, salvo se este comprovar que o empregado obteve novo emprego (Súmula 230).",
        orientacao: "Comunique formalmente a rescisão. No aviso trabalhado, o empregado tem direito a 2h diárias de redução ou 7 dias corridos no fim do período. No indenizado, paga-se o equivalente sem trabalho.",
        palavrasChave: ["aviso prévio", "30 dias", "proporcional", "rescisão", "trabalhado", "indenizado"],
      },
      {
        numero: "Art. 488",
        titulo: "Redução de Jornada no Aviso Trabalhado",
        textoLegal: "O horário normal de trabalho do empregado, durante o prazo do aviso, e se a rescisão tiver sido promovida pelo empregador, será reduzido de 2 (duas) horas diárias, sem prejuízo do salário integral. Parágrafo único. É facultado ao empregado trabalhar sem a redução das duas horas diárias, caso em que poderá faltar ao serviço, sem prejuízo do salário integral, por 7 (sete) dias corridos.",
        comentario: "Durante o aviso prévio trabalhado, o empregado tem direito à redução de 2h diárias OU à ausência de 7 dias corridos. A escolha é do empregado.",
        analise: "Esta redução visa permitir que o empregado busque novo emprego. A renúncia a esse direito é nula (Súmula 230 TST). Direito exclusivo do dispensado, não se aplica ao pedido de demissão.",
        interpretacao: "A redução pode ser no início ou no fim da jornada. Os 7 dias corridos podem ser no início ou no final do aviso. Não há previsão para fracionamento.",
        orientacao: "Pergunte ao empregado qual modalidade prefere e formalize por escrito. Não force a opção. A renúncia é inválida e gera direito ao adicional posteriormente.",
        palavrasChave: ["aviso prévio trabalhado", "redução jornada", "7 dias", "busca emprego"],
      },
      {
        numero: "Art. 484-A",
        titulo: "Rescisão por Acordo entre as Partes",
        textoLegal: "O contrato de trabalho poderá ser extinto por acordo entre empregado e empregador, caso em que serão devidas as seguintes verbas trabalhistas: I - por metade: a) o aviso prévio, se indenizado; e b) a indenização sobre o saldo do FGTS, prevista no § 1º do art. 18 da Lei 8.036/1990; II - na integralidade, as demais verbas trabalhistas. § 1º A extinção do contrato prevista no caput permite a movimentação da conta vinculada do trabalhador no FGTS, limitada até 80% do valor dos depósitos. § 2º A extinção do contrato por acordo prevista no caput não autoriza o ingresso no Programa de Seguro-Desemprego.",
        comentario: "Modalidade criada pela Reforma Trabalhista. Permite o desligamento amigável com pagamento de metade do aviso indenizado e metade da multa do FGTS, mantendo as demais verbas integrais.",
        analise: "É importante destacar que NÃO há direito ao seguro-desemprego nesta modalidade. O saque do FGTS é limitado a 80%. Esta modalidade exige real consenso, sem coação.",
        interpretacao: "A simulação de acordo para mascarar dispensa sem justa causa configura fraude e pode gerar reconhecimento de todos os direitos da dispensa imotivada, incluindo seguro-desemprego.",
        orientacao: "Documente o acordo por escrito. Esclareça ao empregado todas as consequências (especialmente a perda do seguro-desemprego). A homologação sindical, embora facultativa, traz mais segurança.",
        palavrasChave: ["acordo entre partes", "distrato", "rescisão amigável", "484-A"],
      },
      {
        numero: "Lei 8.036/90, Art. 18",
        titulo: "FGTS - Multa Rescisória de 40%",
        textoLegal: "Ocorrendo rescisão do contrato de trabalho, por parte do empregador, ficará este obrigado a depositar na conta vinculada do trabalhador no FGTS os valores relativos aos depósitos referentes ao mês da rescisão e ao imediatamente anterior. § 1º Na hipótese de despedida pelo empregador sem justa causa, depositará este, na conta vinculada do trabalhador no FGTS, importância igual a 40% do montante de todos os depósitos realizados na conta vinculada durante a vigência do contrato de trabalho, atualizados monetariamente e acrescidos dos respectivos juros.",
        comentario: "Na demissão sem justa causa, o empregador paga multa de 40% sobre o saldo do FGTS. A contribuição social adicional de 10% (LC 110/2001) foi extinta em 01/01/2020.",
        analise: "Na rescisão por culpa recíproca ou força maior, a multa é reduzida para 20% (art. 18, § 2º). No acordo entre as partes (art. 484-A CLT), a multa é de 20%.",
        interpretacao: "O empregado pode movimentar 80% do saldo no acordo entre as partes (não 100%). A multa de 40% incide sobre todos os depósitos do contrato, atualizados monetariamente.",
        orientacao: "Calcule a multa sobre o extrato analítico do FGTS, não apenas sobre os depósitos efetivamente feitos. Atenção ao prazo de 10 dias para pagamento das verbas rescisórias.",
        palavrasChave: ["FGTS", "multa 40%", "rescisão", "saldo", "Lei 8036"],
      },
      {
        numero: "Lei 4.090/62 (13º Salário)",
        titulo: "Décimo Terceiro Salário (Gratificação Natalina)",
        textoLegal: "No mês de dezembro de cada ano, a todo empregado será paga, pelo empregador, uma gratificação salarial, independentemente da remuneração a que fizer jus. § 1º A gratificação corresponderá a 1/12 avos da remuneração devida em dezembro, por mês de serviço, do ano correspondente. § 2º A fração igual ou superior a 15 dias de trabalho será havida como mês integral.",
        comentario: "O 13º salário é direito constitucional (art. 7º, VIII, CF/88) regulamentado pela Lei 4.090/62 e Decreto 57.155/65. Calculado proporcionalmente aos meses trabalhados no ano.",
        analise: "Pago em duas parcelas: 1ª parcela entre fevereiro e novembro (geralmente nas férias, se solicitado); 2ª parcela até 20 de dezembro. A 1ª parcela corresponde a metade do salário recebido no mês anterior.",
        interpretacao: "Integram o 13º: horas extras habituais, adicionais (insalubridade, periculosidade, noturno), comissões, gorjetas. Súmula 45 TST: a média das horas extras integra o 13º.",
        orientacao: "Pague rigorosamente nos prazos legais. INSS incide apenas na 2ª parcela; IRRF é calculado em separado. Em caso de rescisão, pague 13º proporcional aos meses trabalhados.",
        palavrasChave: ["13º salário", "gratificação natalina", "1/12", "dezembro", "proporcional"],
      },
      {
        numero: "Art. 473",
        titulo: "Faltas Justificadas Permitidas",
        textoLegal: "O empregado poderá deixar de comparecer ao serviço sem prejuízo do salário: I - até 2 dias consecutivos, em caso de falecimento do cônjuge, ascendente, descendente, irmão ou pessoa que viva sob sua dependência econômica; II - até 3 dias consecutivos, em virtude de casamento; III - por 5 dias, em caso de nascimento de filho, no decorrer da primeira semana; IV - por 1 dia, em cada 12 meses de trabalho, em caso de doação voluntária de sangue; V - até 2 dias consecutivos para se alistar como eleitor; VI - no período de tempo em que tiver de cumprir as exigências do Serviço Militar; VIII - pelo tempo que se fizer necessário, quando tiver que comparecer a juízo; X - até 2 dias para acompanhar consultas médicas e exames complementares durante o período de gravidez de sua esposa ou companheira; XI - por 1 dia por ano para acompanhar filho de até 6 anos em consulta médica.",
        comentario: "Lista taxativa de faltas legalmente justificadas. Outras ausências dependem de previsão em CCT/ACT, regulamento interno ou tolerância do empregador.",
        analise: "A Lei 13.257/2016 (Marco da Primeira Infância) ampliou o rol incluindo acompanhamento de gestante e filhos. A licença-paternidade de 5 dias pode ser estendida para 20 dias no Empresa Cidadã.",
        interpretacao: "O TST entende que esses prazos são mínimos, podendo ser ampliados por norma coletiva. As ausências devem ser comprovadas com documento idôneo (atestado, certidão).",
        orientacao: "Mantenha política clara sobre comprovação de faltas. Aceite os documentos legais. Não confunda faltas justificadas com atestados médicos (que seguem regra própria - art. 6º, § 2º, Lei 605/49).",
        palavrasChave: ["faltas justificadas", "licença", "casamento", "óbito", "paternidade", "doação sangue"],
      },
      {
        numero: "Art. 469",
        titulo: "Transferência de Localidade",
        textoLegal: "Ao empregador é vedado transferir o empregado, sem a sua anuência, para localidade diversa da que resultar do contrato, não se considerando transferência a que não acarretar necessariamente a mudança do seu domicílio. § 1º Não estão compreendidos na proibição deste artigo os empregados que exerçam cargo de confiança e aqueles cujos contratos tenham como condição, implícita ou explícita, a transferência, quando esta decorra de real necessidade de serviço. § 3º Em caso de necessidade de serviço o empregador poderá transferir o empregado para localidade diversa da que resultar do contrato, não obstante as restrições do artigo anterior, mas, nesse caso, ficará obrigado a um adicional de no mínimo 25% dos salários que o empregado percebia naquela localidade, enquanto durar essa situação.",
        comentario: "A transferência que implique mudança de domicílio só é permitida com anuência do empregado, salvo cargo de confiança ou contrato com cláusula expressa.",
        analise: "Mesmo nos casos permitidos, deve haver real necessidade de serviço. A transferência provisória dá direito ao adicional de 25%. As despesas com mudança são por conta do empregador (art. 470).",
        interpretacao: "O TST distingue transferência definitiva (sem adicional, mas com pagamento de despesas) e provisória (com adicional de 25%). A transferência abusiva é nula.",
        orientacao: "Inclua cláusula de transferência apenas se realmente necessário. Documente a real necessidade do serviço. Pague o adicional nas transferências provisórias e arque com despesas de mudança.",
        palavrasChave: ["transferência", "mudança", "adicional 25%", "cargo confiança", "domicílio"],
      },
    ],
  },
  {
